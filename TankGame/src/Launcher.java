...
public class Launcher {
    ...
    public void setFrame(String type){
        ...
        switch (type) {
            ...
            case "end" -> {
                ...
                String winner = GameWorld.getInstance().getWinner();
                EndGamePanel endPanel = (EndGamePanel) mainPanel.getComponent(2);
                endPanel.setWinnerMessage(winner);
            }
        }
    ...
    public void restartGame() {
        ...
        this.gamePanel.InitializeGame(); // Initialize the game, but do not start it yet

        // Replace the existing game panel with the new one
        this.mainPanel.remove(1);  // Remove the old game panel
        this.mainPanel.add(gamePanel, "game");  // Add the new game panel
